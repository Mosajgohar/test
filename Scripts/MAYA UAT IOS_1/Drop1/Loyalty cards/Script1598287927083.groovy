...
Mobile.setText(findTestObject('null'), 'automation loyalty', 
    0)
...
Mobile.setText(findTestObject('null'), '11', 0)
...
Mobile.setText(findTestObject('null'), '111222333444555666777888999000', 
    0)
...
Mobile.setText(findTestObject('null'), '10/25', 0)
...
Mobile.setText(findTestObject('null'), 'automation test', 
    0)
...
not_run: Mobile.verifyElementExist(findTestObject('null'), 0)
...
not_run: Mobile.verifyElementChecked(findTestObject('null'), 0)
